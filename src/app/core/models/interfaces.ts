...
export interface IPharmacie { id:number; nom:string; adresse?:string; codePostal?:string; ville?:string; telephone?:string; email?:string; latitude?:number; longitude?:number; actif:boolean; createdAt?:string; updatedAt?:string; distance?:number; }
...
// centres_sante: id, nom, adresse, latitude, longitude, telephone, email, description, specialites, services, actif, created_at
export interface ICentreSante { id:number; nom:string; adresse?:string; latitude?:number; longitude?:number; telephone?:string; email?:string; description?:string; specialites?:string; services?:string; actif:boolean; createdAt?:string; distance?:number; }
...
export interface IAdminStats { patients:number; medecins:number; pharmacies:number; centresAnalyse:number; rdvCeMois:number; rdvConfirmes:number; rdvAnnules:number; commandesTotales:number; commandesAttente:number; demandesPro:number; alertesStock:IAlertStock[]; }
