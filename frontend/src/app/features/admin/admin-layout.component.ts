...
@Component({
  ...
  styles: [`
    ...
    .sidebar .nav-link { border-radius: 8px; transition: background .15s, color .15s; font-size: .875rem; }
    ...
    <div class="d-flex" style="min-height:100vh; background:#f1f5f9;">
      ...
      <aside class="sidebar bg-dark text-white d-flex flex-column"
        ...
        <div class="p-3 border-bottom border-secondary">
          <div class="d-flex align-items-center gap-2">
            ...
            <div>
              ...
              <div class="text-muted" style="font-size:.68rem;letter-spacing:.05em;">ADMINISTRATION</div>
            </div>
          </div>
        </div>
        ...
        <nav class="flex-grow-1 p-2 pt-3">
          <p class="text-muted px-2 mb-1" style="font-size:.65rem;letter-spacing:.08em;text-transform:uppercase;">
            Principal
          </p>
          <ul class="nav flex-column gap-1 mb-3">
            ...
            <li class="nav-item">
              <a routerLink="demandes" routerLinkActive="active-link"
                 (click)="open.set(false)"
                 class="nav-link text-white d-flex align-items-center gap-2 px-3 py-2">
                <i class="bi bi-person-check fs-5"></i>
                <span class="d-inline">Demandes</span>
              </a>
            </li>
            <li class="nav-item">
          ...
          <ul class="nav flex-column gap-1">
            <li class="nav-item">
              <a routerLink="pharmacies" routerLinkActive="active-link"
                 (click)="open.set(false)"
                 class="nav-link text-white d-flex align-items-center gap-2 px-3 py-2">
                <i class="bi bi-capsule fs-5"></i>
                <span class="d-inline">Pharmacies</span>
              </a>
            </li>
            <li class="nav-item">
              <a routerLink="centres" routerLinkActive="active-link"
                 (click)="open.set(false)"
                 class="nav-link text-white d-flex align-items-center gap-2 px-3 py-2">
                <i class="bi bi-building-cross fs-5"></i>
                <span class="d-inline">Centres</span>
              </a>
            </li>
          </ul>

          <p class="text-muted px-2 mb-1 mt-3" style="font-size:.65rem;letter-spacing:.08em;text-transform:uppercase;">
            Médical & Sécurité
          </p>
          <ul class="nav flex-column gap-1">
            <li class="nav-item">
              <a routerLink="patients" routerLinkActive="active-link"
                ...
                <span class="d-inline">Patients</span>
              </a>
            </li>
            <li class="nav-item">
              <a routerLink="medecins" routerLinkActive="active-link"
                 (click)="open.set(false)"
                 class="nav-link text-white d-flex align-items-center gap-2 px-3 py-2">
                <i class="bi bi-stethoscope fs-5"></i>
                <span class="d-inline">Médecins</span>
              </a>
            </li>
            <li class="nav-item">
              <a routerLink="logs" routerLinkActive="active-link"
                ...
                <span class="d-inline">Logs</span>
              </a>
            </li>
            <li class="nav-item">
              <a routerLink="auth-dashboard" routerLinkActive="active-link"
                 (click)="open.set(false)"
                 class="nav-link text-white d-flex align-items-center gap-2 px-3 py-2">
                <i class="bi bi-shield-exclamation fs-5"></i>
                <span class="d-inline">Sécurité</span>
              </a>
            </li>
          </ul>
        </nav>
        ...
        <div class="p-3 border-top border-secondary">
          <div class="d-flex align-items-center gap-2">
            ...
            <div class="flex-grow-1 overflow-hidden">
              ...
              <div class="text-muted" style="font-size:.68rem;">Administrateur</div>
            </div>
      ...
      <div class="flex-grow-1 d-flex flex-column overflow-hidden">
        ...
        <header class="topbar bg-white border-bottom px-3 px-md-4 d-flex align-items-center
          ...
          <div class="d-flex align-items-center gap-2">
            ...
            <i class="bi bi-grid-3x3-gap text-muted d-none d-md-inline"></i>
            <span class="fw-semibold text-dark" style="font-size:.9rem;">Espace administration</span>
          </div>
