// features/pharmacie/pharmacie-layout.component.ts
      ...
      <aside class="sidebar bg-dark text-white d-flex flex-column"
        ...
        <div class="p-3 border-bottom border-secondary">
          <div class="d-flex align-items-center gap-2">
            ...
            <div>
              ...
              <div class="text-muted" style="font-size:.68rem;letter-spacing:.05em;">PHARMACIE</div>
            </div>
          </div>
        </div>
        ...
        <nav class="flex-grow-1 p-2 pt-3">
          ...
          <ul class="nav flex-column gap-1">
            <li class="nav-item">
              <a routerLink="stock" routerLinkActive="active-link"
                 (click)="open.set(false)"
                 class="nav-link text-white d-flex align-items-center gap-2 px-3 py-2">
                <i class="bi bi-box-seam fs-5"></i>
                <span class="d-inline">Stock / Inventaire</span>
              </a>
            </li>
            <li class="nav-item">
        ...
        <div class="p-3 border-top border-secondary">
          <div class="d-flex align-items-center gap-2">
            ...
            <div class="flex-grow-1 overflow-hidden">
              ...
              <div class="text-muted" style="font-size:.68rem;">Pharmacie</div>
            </div>
      ...
      <div class="flex-grow-1 d-flex flex-column overflow-hidden">
        ...
        <header class="topbar bg-white border-bottom px-3 px-md-4 d-flex align-items-center
          ...
          <div class="d-flex align-items-center gap-2">
            ...
            <i class="bi bi-capsule text-muted d-none d-md-inline"></i>
            <span class="fw-semibold text-dark" style="font-size:.9rem;">Espace pharmacie</span>
          </div>
          <span class="badge rounded-pill bg-success-subtle text-success small">
            <i class="bi bi-check-circle me-1"></i>
            <span class="d-none d-md-inline">Pharmacien</span>
          </span>
        </header>
...
export class PharmacieLayoutComponent {
