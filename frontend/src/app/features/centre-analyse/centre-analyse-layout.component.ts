...
@Component({
  selector  : 'app-centre-analyse-layout',
  standalone: true,
  ...
  styles: [`
    ...
    .sidebar .nav-link.active-link { background: #198754 !important; color: #fff !important; }
    .topbar { height: 56px; }
      ...
      <aside class="sidebar bg-dark text-white d-flex flex-column"
        ...
        <div class="p-3 border-bottom border-secondary">
          <div class="d-flex align-items-center gap-2">
            <i class="bi bi-eyedropper text-success fs-5"></i>
            <div>
              <div class="fw-bold lh-1" style="font-size:.9rem;">MediConnect</div>
              <div class="text-muted" style="font-size:.68rem;letter-spacing:.05em;">CENTRE ANALYSE</div>
            </div>
          </div>
        </div>
        ...
        <nav class="flex-grow-1 p-2 pt-3">
          ...
          <ul class="nav flex-column gap-1">
            ...
            <li class="nav-item">
              <a routerLink="analyses" routerLinkActive="active-link"
                 (click)="open.set(false)"
                 class="nav-link text-white d-flex align-items-center gap-2 px-3 py-2">
                <i class="bi bi-list-check fs-5"></i>
                <span class="d-inline">Mes analyses</span>
              </a>
            </li>
          </ul>
        </nav>
        ...
        <div class="p-3 border-top border-secondary">
          <div class="d-flex align-items-center gap-2">
            <div class="avatar rounded-circle bg-success d-flex align-items-center
            ...
            <div class="flex-grow-1 overflow-hidden">
              ...
              <div class="text-muted" style="font-size:.68rem;">Centre d'analyse</div>
            </div>
      ...
      <div class="flex-grow-1 d-flex flex-column overflow-hidden">
        ...
        <header class="topbar bg-white border-bottom px-3 px-md-4 d-flex align-items-center
          ...
          <div class="d-flex align-items-center gap-2">
            ...
            <i class="bi bi-eyedropper text-muted d-none d-md-inline"></i>
            <span class="fw-semibold text-dark" style="font-size:.9rem;">Espace centre d'analyse</span>
          </div>
...
export class CentreAnalyseLayoutComponent {
  ...
  initiales(): string {
    ...
    if (!u) return 'CA';
    return ((u.prenom?.[0] ?? '') + (u.nom?.[0] ?? '')).toUpperCase() || 'CA';
  }
}
